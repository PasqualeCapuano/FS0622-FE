...
@Component({
  ...
  <div class="card-body text-white">
    <h2 class="card-title mb-4 logo fw-bold">NETFLICS</h2>
  ...
  <button type="submit" [disabled]="form.invalid" class="btn btn-primary raise rounded-5 px-5">Login</button>
</form>
  </div>
  <hr class="border border-white">
<p class="text-white">Non sei registrato ? <a class="text-primary text-decoration-none" [routerLink]="['/register']">Registrati</a></p>
</div>
</div>
  `,
  styles: [
