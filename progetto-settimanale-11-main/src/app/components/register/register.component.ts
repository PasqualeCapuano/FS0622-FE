...
@Component({
  ...
  <div class="card-body text-white">
    <h1 class="card-title mb-4 logo fw-bold">NETFLICS</h1>
  ...
  <button type="submit" class="btn raise btn-primary rounded-5 px-5" [disabled]="form.invalid">Registrati</button>
</form>
  </div>
  <hr class="border border-white">
<p class="text-white">Sei già registrato? Effettua il <a class="text-primary text-decoration-none" [routerLink]="['/login']">Login</a></p>
</div>
</div>
  `,
  styles: [
